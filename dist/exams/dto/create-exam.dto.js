...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: '科目不能为空' }),
    (0, class_validator_1.IsString)({ message: '科目必须是字符串' }),
    __metadata("design:type", String)
], CreateExamDto.prototype, "subject", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: '班级不能为空' }),
    (0, class_validator_1.IsString)({ message: '班级必须是字符串' }),
    __metadata("design:type", String)
], CreateExamDto.prototype, "className", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: '考试日期不能为空' }),
