...
async function bootstrap() {
    ...
    const studentsService = app.get(students_service_1.StudentsService);
    const examsService = app.get(exams_service_1.ExamsService);
    const scoresService = app.get(scores_service_1.ScoresService);
